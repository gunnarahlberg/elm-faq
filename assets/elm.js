...
var _user$project$Filter$filterSections = F2(
	function (filter, sections) {
		var matches = function (section) {
			var _p0 = filter;
			if (_p0.ctor === 'Just') {
				return A2(_user$project$Filter$match, _p0._0, section);
			} else {
				return true;
			}
		};
		return A2(_elm_lang$core$List$filter, matches, sections);
	});
var _user$project$Filter$sectionList = function (model) {
	var link = F2(
		function (id, text) {
			return A2(
	...
	var sectionListItem = function (section) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(link, section.id, section.title)
				]));
	};
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('section-list')
			]),
		A2(
			_elm_lang$core$List$map,
			sectionListItem,
			A2(_user$project$Filter$filterSections, model.filter, model.sections)));
};
var _user$project$Filter$update = F2(
	function (msg, model) {
		var _p1 = A2(_elm_lang$core$Debug$log, 'msg', msg);
		if (_p1.ctor === 'UpdateFilter') {
			var _p2 = _p1._0;
			var filter = _elm_lang$core$Native_Utils.eq(_p2, '') ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p2);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Filter$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {message: 'Hello', sections: flags, filter: _elm_lang$core$Maybe$Nothing},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Filter$Section = F3(
	function (a, b, c) {
		return {id: a, title: b, content: c};
	});
var _user$project$Filter$Model = F3(
	function (a, b, c) {
		return {message: a, sections: b, filter: c};
	});
var _user$project$Filter$ResetFilter = {ctor: 'ResetFilter'};
var _user$project$Filter$resetButton = function (model) {
	...
	if (_p3.ctor === 'Just') {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(_user$project$Filter$ResetFilter),
					_elm_lang$html$Html_Attributes$class('reset-filter')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$Filter$UpdateFilter = function (a) {
	return {ctor: 'UpdateFilter', _0: a};
};
var _user$project$Filter$filterInput = function (model) {
	var val = A2(_elm_lang$core$Maybe$withDefault, '', model.filter);
	return A2(
		_elm_lang$html$Html$input,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onInput(_user$project$Filter$UpdateFilter),
				_elm_lang$html$Html_Attributes$value(val),
				_elm_lang$html$Html_Attributes$class('filter'),
				_elm_lang$html$Html_Attributes$placeholder('search contents')
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Filter$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Filter$filterInput(model),
				_user$project$Filter$resetButton(model),
				_user$project$Filter$sectionList(model)
			]));
};
var _user$project$Filter$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _user$project$Filter$init,
			update: _user$project$Filter$update,
			view: _user$project$Filter$view,
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Filter'], 'Filter', typeof _user$project$Filter$main === 'undefined' ? null : _user$project$Filter$main);
