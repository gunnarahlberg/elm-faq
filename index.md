...
Elm-reactor can act as a simple HTTP server, so you can write a custom HTML file
that links in your CSS and the elm.js generated by Elm and then load that HTML
file in elm-reactor. E.g. create a main.html in the same directory as your
elm.js and my.css files like this:
...
Also consider using other hot-reload tools:
[elm-live](https://github.com/tomekwi/elm-live),
[elm-hot-loader](https://github.com/fluxxu/elm-hot-loader) (for use with webpack),
[elm-webpack-started](https://github.com/moarwick/elm-webpack-starter)
